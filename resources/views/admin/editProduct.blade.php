            ...
            <div class="card card-success">
              ...
              @if(count($errors)> 0)
                <div class="alert alert-danger">
                 ...
                 {!!Form::Open(['action'=>'App\Http\Controllers\productController@update', 'method'=>'POST', 'enctype'=>'multipart/form-data' ])!!}
                 {{ csrf_field() }}
                 <div class="card-body">
                 ...
                 {{Form::Label('','Product Name',['for'=>'productName'])}}
                  {{Form::Text('productName',$products->productName,['class'=>'form-control','id'=>'productName','placeholder'=>'Enter Product Name'])}}
                  </div>
                  <div class="form-group">
                    {{Form::Label('','Product Price',['for'=>'productPrice'])}}
                    {{Form::Text('productPrice',$products->productPrice,['class'=>'form-control','id'=>'productPrice','placeholder'=>'Enter Product price'])}}
                   </div>
                  <div class="form-group">      
